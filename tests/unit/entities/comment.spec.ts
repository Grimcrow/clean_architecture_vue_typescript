...
import { mockComments, mockCommentsData } from "@/entities/comment";

describe(">>> Comment", () => {
  it("should instantiate id only if i was provided", () => {
  ...
  describe(">> validate", () => {
    ...
    it("should fail validatio if title is too long", () => {
      const entity = new Comment({
        ...mockCommentsData()[0],
